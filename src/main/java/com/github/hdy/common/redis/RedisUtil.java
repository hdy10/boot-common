...
public class RedisUtil {
     ...
     * @return
     */
    public boolean addSet(String key, Object item) {
        try {
     ...
     * @return true 成功 false 失败
     */
    public boolean setSet(String key, Set<Object> set, long time) {
        try {
            set.forEach(o -> {
                addSet(key, o);
            });
     ...
     * @return
     */
    public boolean removeSetOps(String key, Object... item) {
        try {
